...
public class GeTuiIntentService extends GTIntentService {
    ...
    private static final String TAG = "GetuiServer";
    ...
    public void onReceiveClientId(Context context, String clientid) {
        LogUtils.d(TAG, "onReceiveClientId -> " + "clientid = " + clientid);
    }
    ...
    private void setTagResult(SetTagCmdMessage setTagCmdMsg) {
        ...
        LogUtils.d(TAG, "settag result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));
    }
    //绑定别名回调
    private void bindAliasResult(BindAliasCmdMessage bindAliasCmdMessage) {
        ...
        LogUtils.d(TAG, "bindAlias result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));
    ...
    private void unbindAliasResult(UnBindAliasCmdMessage unBindAliasCmdMessage) {
        ...
        LogUtils.d(TAG, "unbindAlias result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));
